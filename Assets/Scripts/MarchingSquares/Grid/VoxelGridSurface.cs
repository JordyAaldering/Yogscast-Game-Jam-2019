...
namespace MarchingSquares.Grid
{
    public class VoxelGridSurface : MonoBehaviour
    {
        ...
        {
            AddPentagon(cornersMin[i], cornersMax[i], xEdgesMax[i], yEdgeMax, cornersMin[i + 1]);
        }

        public void AddHexagonABC(int i, Vector2 extraVertex)
        {
            AddHexagon(vertices.Count, yEdgeMax, cornersMin[i + 1], cornersMin[i], cornersMax[i], xEdgesMax[i]);
            vertices.Add(extraVertex);
        }

        public void AddPentagonABD(int i)
        {
            AddPentagon(cornersMin[i + 1], cornersMin[i], yEdgeMin, xEdgesMax[i], cornersMax[i + 1]);
        }

        public void AddHexagonABD(int i, Vector2 extraVertex)
        {
            AddHexagon(vertices.Count, xEdgesMax[i], cornersMax[i + 1], cornersMin[i + 1], cornersMin[i], yEdgeMin);
            vertices.Add(extraVertex);
        }

        public void AddPentagonACD(int i)
        {
            AddPentagon(cornersMax[i], cornersMax[i + 1], yEdgeMax, xEdgesMin[i], cornersMin[i]);
        }

        public void AddHexagonACD(int i, Vector2 extraVertex)
        {
            AddHexagon(vertices.Count, xEdgesMin[i], cornersMin[i], cornersMax[i], cornersMax[i + 1], yEdgeMax);
            vertices.Add(extraVertex);
        }

        public void AddPentagonBCD(int i)
        {
            AddPentagon(cornersMax[i + 1], cornersMin[i + 1], xEdgesMin[i], yEdgeMin, cornersMax[i]);
        }

        public void AddHexagonBCD(int i, Vector2 extraVertex)
        {
            AddHexagon(vertices.Count, yEdgeMin, cornersMax[i], cornersMax[i + 1], cornersMin[i + 1], xEdgesMin[i]);
            vertices.Add(extraVertex);
        }
        ...
        {
            AddPentagon(vertices.Count, xEdgesMin[i], cornersMin[i], cornersMax[i], xEdgesMax[i]);
            vertices.Add(extraVertex);
        }
        ...
        {
            AddPentagon(vertices.Count, xEdgesMax[i], cornersMax[i + 1], cornersMin[i + 1], xEdgesMin[i]);
            vertices.Add(extraVertex);
        }
        ...
        {
            AddPentagon(vertices.Count, yEdgeMin, cornersMax[i], cornersMin[i + 1], xEdgesMin[i]);
            vertices.Add(extraVertex);
        }
        ...
        {
            AddPentagon(vertices.Count, yEdgeMax, cornersMin[i + 1], cornersMax[i], xEdgesMax[i]);
            vertices.Add(extraVertex);
        }
        ...
        {
            AddPentagon(vertices.Count, xEdgesMin[i], cornersMin[i], cornersMax[i + 1], yEdgeMax);
            vertices.Add(extraVertex);
        }
        ...
        {
            AddPentagon(vertices.Count, xEdgesMax[i], cornersMax[i + 1], cornersMin[i], yEdgeMin);
            vertices.Add(extraVertex);
        }
